...
def votingPg(root,frame1,client_socket):
    ...
    bjpLogo = ImageTk.PhotoImage((Image.open(path / 'bjp.png')).resize((45,45)))
    ...
    congLogo = ImageTk.PhotoImage((Image.open(path / 'cong.jpg')).resize((35,48)))
    ...
    aapLogo = ImageTk.PhotoImage((Image.open(path / 'aap.png')).resize((55,40)))
    ...
    ssLogo = ImageTk.PhotoImage((Image.open(path / 'ss.png')).resize((50,45)))
    ...
    notaLogo = ImageTk.PhotoImage((Image.open(path / 'nota.jpg')).resize((45,35)))
